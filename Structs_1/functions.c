...
void mitjana(int x ,int y) {
	float mitjana;
	mitjana= x / y;
	printf("La mitjana és: %.2f",mitjana);
}
...
void modifyData(struct office *o,int size){
        ...
        scanf("%d",&o[i].workers);
        printf("Introdueix quin dia és:  \n");
        scanf("%d",&o[i].data.dia);
        printf("Introdueix quin més és:  \n");
        scanf("%d",&o[i].data.mes);
        printf("Introdueix quin any és:  \n");
        scanf("%d",&o[i].data.any);
    }
}
...
void printData(struct office *o, int size){
    ...
    for(int i=0; i<size; i++){
        ...
        printf("Aquesta és la data d'avui: %d/%d/%d\n",o[i].data.dia,o[i].data.mes,o[i].data.any);
        printf("------------------------------------------------\n");
    }
}
